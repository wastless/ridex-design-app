...
export default function BasicSettings({
  ...
  return (
    <>
      ...
      {/* Размер */}
      <div className="flex flex-row items-center justify-between">
        <span className="text-paragraph-sm text-text-strong-950">Размер</span>
        <div className="flex w-[154px] flex-row gap-1.5">
          <Input.Root>
            <Input.Wrapper>
              <Input.Icon as={W_16} />
              <Input.Input
                ...
                onChange={(e) => {
                  const number = parseInt(e.target.value);
                  if (!isNaN(number) && layer.type !== LayerType.Path) {
      ...
      {/* Радиус скругления */}
      <div className="flex flex-row items-center justify-between">
        <span className="text-paragraph-sm text-text-strong-950">Радиус</span>
        <div className="flex w-[154px] flex-row gap-1.5">
          <Input.Root>
            <Input.Wrapper>
