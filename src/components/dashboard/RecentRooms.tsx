...
/**
 * Компонент отображения недавних проектов пользователя
 * Показывает карточки проектов с возможностью сортировки и выбора
 */
...
export default function RecentRooms() {
  ...
  return (
    <div ref={outerDivRef}>
      <div className="space-y-6 px-8 pb-5 pt-2">
