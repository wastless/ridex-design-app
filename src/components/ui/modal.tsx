...
>(({ className, ...rest }, forwardedRef) => {
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        // base
        'fixed inset-0 z-[51] flex flex-col items-center justify-center overflow-y-auto bg-overlay p-4 backdrop-blur-[10px]',
        // animation
...
function ModalHeader({
  ...
  return (
    <div
      className={cn(
        'relative flex items-start gap-3.5 pb-4 pt-5 pl-5 pr-12 before:absolute before:inset-x-0 before:bottom-0 before:border-b before:border-stroke-soft-200',
        className,
      )}
      {...rest}
    >
